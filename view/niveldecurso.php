...
<div class="contenedor active" id="contenedor">
        ...
        <?php require './includes/header.php'?>
         ...
         <?php $page = 'nivelCursos'; require './includes/sidebar.php'?>
        ...
        <main class="main">
            ...
            <!-- Contendor genral de la card  visual de la tabla -->
                <div class="card">
                <input class="input-search" type="text" name="" placeholder="Buscar nivel" id="searchRegister">
                    <div class="card-header">
                      <h3 class="table-h3">Tabla de Niveles de curso</h3>
                      ...
                      <table class="table table-striped table-hover">
                        <thead>
                          <tr>
                            ...
                            <tbody>
                               <tr  v-for="(nivel, index) in nivelcursos" v-show="index >=  anterior && index < siguiente">
                                  <td>{{nivel.id}}</td>
                                  <td>{{nivel.nombreNivel}}</td>
                              
                                  <td>
                                    <button  type="button"  class="btn btn-success "  data-toggle="modal" data-target="#updateModal" @click= "setDatos(nivel)" ><i class="far fa-edit"></i> Editar</button>
                                    <button type="button"  class="btn btn-delete " data-toggle="modal" data-target="#deleteModal" @click= "setDatosDelete(nivel)"><i class="fas fa-trash-alt"></i> Eliminar</button>
                                  </td>
                            </tr>
        ...
        <!-- Modal insertrar -->
          <div class="modal fade" id="insertModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog ">
              <div class="modal-content">
                ...
                <h3 class="modal-title" id="exampleModalLabel"> Agregar Nivel</h3>
                   ...
                   <form action="" class="">
                    <div class="row">
                      <div class="form-group col">
                          ...
                          <input class="form-control" type="text" name="" id="insert-nombreNivel">
                      </div>
                    </div>
           ...
           <div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog ">
              <div class="modal-content">
                <div class="modal-header">
                <h3 class="modal-title" id="exampleModalLabel"> Actualizar Nivel</h3>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                  ...
                  <form action="" class="">
                    <div class="row">
                      <div class="form-group col">
                          ...
                          <label for="">Nombre:</label>
                          <input class="form-control" type="text" name="" id="update-nombreNivel">
                      </div>
                    </div>
          ...
          <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog ">
              <div class="modal-content">
                <div class="modal-header">
                  <h3 class="modal-title" id="exampleModalLabel"> Eliminar nivel</h3>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                  ...
                  <form action="" class="">
                    ...
                    <div class="container-alert mt-0">
                      ...
                      <div class="form-group col">
                          ...
                          <label for="">Nombre:</label>
                          <input class="form-control" type="text" name="" id="delete-nombreNivel">
     ...
     <script src="../src/js/crud_nivelcurso.js" ></script>
