...
<div class="contenedor active" id="contenedor">
        <?php require './includes/header.php'?>
         ...
         <?php $page = 'tipoPromocion'; require './includes/sidebar.php'?>
        ...
        <main class="main">
            ...
            <div class="wrap-table100" id="wrap-table">
                <div class="card">
                <input class="input-search" type="text" name="" placeholder="Buscar Tipo de promocion" id="searchRegister">

                    <div class="card-header">
                      
                      <h3 class="table-h3">Tabla de Tipo de promociones</h3>
                      ...
                      <table class="table table-striped table-hover">
                        <thead>
                          <tr>
                            ...
                            <tbody>
                               <tr  v-for="(promo, index) in registros" v-show="index >=  anterior && index < siguiente">
                                  <td>{{promo.id}}</td>
                                  <td>{{promo.nombreTipoPromo}}</td>
                                  <td>
                                    <button  type="button"  class="btn btn-success "  data-toggle="modal" data-target="#updateModal" @click= "setDatos(promo)" ><i class="far fa-edit"></i></button>
                                    <button type="button"  class="btn btn-delete " data-toggle="modal" data-target="#deleteModal" @click= "setDatosDelete(promo)"><i class="fas fa-trash-alt"></i></button>
                                  </td>
                            </tr>
        ...
        <!-- Modal insertrar -->
          <div class="modal fade" id="insertModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog ">
              <div class="modal-content">
                ...
                <h3 class="modal-title" id="exampleModalLabel"> Agregar un tipo de promocion</h3>
                   ...
                   <form action="" class="">
                    <div class="row">
                      <div class="form-group col">
                          <label for="">Nombre del la promo:</label>
                          <input class="form-control" type="text" name="" id="insert-nombrePromo">
                      </div>
                    </div>
                  </form>
                </div>
           ...
           <div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog ">
              <div class="modal-content">
                <div class="modal-header">
                <h3 class="modal-title" id="exampleModalLabel"> Actualizar tipo de promocion</h3>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                  ...
                  <form action="" class="">
                    <div class="row">
                      <div class="form-group col">
                          ...
                          <label for="">Nombre de la promo:</label>
                          <input class="form-control" type="text" name="" id="update-nombrePromo">
                      </div>
                    </div>
          ...
          <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog ">
              <div class="modal-content">
                <div class="modal-header">
                  <h3 class="modal-title" id="exampleModalLabel"> Eliminar Tipo de promo</h3>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                  ...
                  <form action="" class="">
                    ...
                    <div class="container-alert mt-0">
                      ...
                      <div class="form-group col">
                          ...
                          <input class="form-control" type="text" name="" id="delete-nombrePromo" disabled>
     ...
     <script src="../src/js/crud_tipo_promo.js"></script>
