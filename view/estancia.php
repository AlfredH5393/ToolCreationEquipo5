...
<div class="contenedor active" id="contenedor">
            ...
            <!-- Contendor genral de la card  visual de la tabla -->
                ...
                <input class="input-search" type="text" name="" placeholder="Buscar Estado" id="searchRegister">
                    <div class="card-header">
                      <h3 class="table-h3">Tabla de Universidades</h3>
                      ...
                      <table class="table table-striped table-hover">
                        <thead>
                          <tr>
                            ...
                            <tbody>
                               <tr  v-for="(estado, index) in estancias" v-show="index >=  anterior && index < siguiente">
                                  <td>{{estado.id}}</td>
                                  <td>{{estado.nombreEstancia}}</td>
        ...
        <!-- Modal insertrar -->
          <div class="modal fade" id="insertModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog ">
              <div class="modal-content">
                ...
                <h3 class="modal-title" id="exampleModalLabel"> Agregar Estancia</h3>
                   ...
                   <form action="" class="">
                    <div class="row">
                      <div class="form-group col">
                          ...
                          <input class="form-control" type="text" name="" id="insert-nombreEstancia">
                      </div>
                    </div>
           ...
           <div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog ">
              <div class="modal-content">
                <div class="modal-header">
                <h3 class="modal-title" id="exampleModalLabel"> Actualizar Estancia</h3>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                  ...
                  <form action="" class="">
                    <div class="row">
                      <div class="form-group col">
                          ...
                          <label for="">Nombre:</label>
                          <input class="form-control" type="text" name="" id="update-nombreEstancia">
                      </div>
                    </div>
          ...
          <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog ">
              <div class="modal-content">
                <div class="modal-header">
                  <h3 class="modal-title" id="exampleModalLabel"> Eliminar estancia</h3>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                  ...
                  <form action="" class="">
                    ...
                    <div class="container-alert mt-0">
                      ...
                      <div class="form-group col">
                          ...
                          <label for="">Nombre:</label>
                          <input class="form-control" type="text" name="" id="delete-nombreEstancia">
     ...
     <script src="../src/js/crud_estancia.js" ></script>
