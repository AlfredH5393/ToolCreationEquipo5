...
<div class="contenedor active" id="contenedor">
                      ...
                      <table class="table table-striped table-hover">
                        <thead>
                          <tr>
                            ...
                            <tbody>
                               <tr  v-for="(estado, index) in estadotemas" v-show="index >=  anterior && index < siguiente">
                                  <td>{{estado.id}}</td>
                                  <td>{{estado.nombreEstadoTema}}</td>
                   ...
                   <form action="" class="">
                    <div class="row">
                      <div class="form-group col">
                          ...
                          <input class="form-control" type="text" name="" id="insert-nombreEstadoTema">
                      </div>
                    </div>
                  ...
                  <form action="" class="">
                    <div class="row">
                      <div class="form-group col">
                          ...
                          <label for="">Nombre del estado:</label>
                          <input class="form-control" type="text" name="" id="update-nombreEstadoTema">
                      </div>
                    </div>
                  ...
                  <form action="" class="">
                    ...
                    <div class="container-alert mt-0">
                      ...
                      <div class="form-group col">
                          ...
                          <input class="form-control" type="text" name="" id="delete-nombreEstadoTema">
     ...
     <script src="../src/js/crud_estadotema.js" ></script>
