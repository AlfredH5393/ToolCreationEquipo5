...
<div class="contenedor active" id="contenedor">
        ...
        <?php require './includes/header.php'?>
         ...
         <?php $page = 'categorias'; require './includes/sidebar.php'?>
        ...
        <main class="main">
            ...
            <!-- Contendor genral de la card  visual de la tabla -->
                <div class="card">
                <input class="input-search" type="text" name="" placeholder="Buscar categoria" id="searchRegister">
                    <div class="card-header">
                      <h3 class="table-h3">Tabla de Categorias</h3>
                      ...
                      <table class="table table-striped table-hover">
                        <thead>
                          <tr>
                            ...
                            <tbody>
                               <tr  v-for="(categoria, index) in categorias" v-show="index >=  anterior && index < siguiente">
                                  <td>{{categoria.id}}</td>
                                  <td>{{categoria.nombreCategoria}}</td>
                              
                                  <td>
                                    <button  type="button"  class="btn btn-success "  data-toggle="modal" data-target="#updateModal" @click= "setDatos(categoria)" ><i class="far fa-edit"></i> Editar</button>
                                    <button type="button"  class="btn btn-delete " data-toggle="modal" data-target="#deleteModal" @click= "setDatosDelete(categoria)"><i class="fas fa-trash-alt"></i> Eliminar</button>
                                  </td>
                            </tr>
        ...
        <!-- Modal insertrar -->
          <div class="modal fade" id="insertModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                   ...
                   <form action="" class="">
                    <div class="row">
                      <div class="form-group col">
                          ...
                          <input class="form-control" type="text" name="" id="insert-nombreCategoria">
                      </div>
                    </div>
           ...
           <div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog ">
              <div class="modal-content">
                <div class="modal-header">
                <h3 class="modal-title" id="exampleModalLabel"> Actualizar Categoria</h3>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                  ...
                  <form action="" class="">
                    <div class="row">
                      <div class="form-group col">
                          ...
                          <label for="">Nombre de la Categoria:</label>
                          <input class="form-control" type="text" name="" id="update-nombreCategoria">
                      </div>
                    </div>
          ...
          <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog ">
              <div class="modal-content">
                <div class="modal-header">
                  <h3 class="modal-title" id="exampleModalLabel"> Eliminar Categoria</h3>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                  ...
                  <form action="" class="">
                    ...
                    <div class="container-alert mt-0">
                      ...
                      <div class="form-group col">
                          ...
                          <input class="form-control" type="text" name="" id="delete-nombreCategoria">
     ...
     <script src="../src/js/crud_categoria.js" ></script>
