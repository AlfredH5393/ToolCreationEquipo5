...
<div class="contenedor active" id="contenedor">
        ...
        <?php require './includes/header.php'?>
         ...
         <?php $page = 'estadoUser'; require './includes/sidebar.php'?>
        ...
        <main class="main">
            ...
            <!-- Contendor genral de la card  visual de la tabla -->
                <div class="card">
                <input class="input-search" type="text" name="" placeholder="Buscar Estado" id="searchRegister">
                    <div class="card-header">
                      <h3 class="table-h3">Tabla de Estados</h3>
                      ...
                      <table class="table table-striped table-hover">
                        <thead>
                          <tr>
                            ...
                            <tbody>
                               <tr  v-for="(estado, index) in estadousuarios" v-show="index >=  anterior && index < siguiente">
                                  <td>{{estado.id}}</td>
                                  <td>{{estado.nombreEstado}}</td>
                                  <td>{{estado.descripcion}}</td>
                            
                                  <td>
                                    <button  type="button"  class="btn btn-success "  data-toggle="modal" data-target="#updateModal" @click= "setDatos(estado)" ><i class="far fa-edit"></i> Editar</button>
                                    <button type="button"  class="btn btn-delete " data-toggle="modal" data-target="#deleteModal" @click= "setDatosDelete(estado)"><i class="fas fa-trash-alt"></i> Eliminar</button>
                                  </td>
                            </tr>
        ...
        <!-- Modal insertrar -->
                   ...
                   <form action="" class="">
                    <div class="row">
                      <div class="form-group col">
                          ...
                          <input class="form-control" type="text" name="" id="insert-nombreEstadoUsuario">
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="form-group col">
                          ...
                          <textarea class="form-control" name="" id="insert-desc" cols="30" rows="5"></textarea>
                      </div>
                    </div>
                  ...
                  <form action="" class="">
                    <div class="row">
                      <div class="form-group col">
                          ...
                          <label for="">Nombre del estado:</label>
                          <input class="form-control" type="text" name="" id="update-nombreEstadoUsuario">
                      </div>
                    </div>
                    <div class="row">
                      <div class="form-group col">
                          <label for="">Descripcion</label>
                          <textarea class="form-control" name="" id="update-desc" cols="30" rows="5"></textarea>
                      </div>
                    </div>
          ...
          <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog ">
              <div class="modal-content">
                <div class="modal-header">
                  <h3 class="modal-title" id="exampleModalLabel"> Eliminar estado</h3>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                  ...
                  <form action="" class="">
                    ...
                    <div class="container-alert mt-0">
                      ...
                      <div class="form-group col">
                          ...
                          <input class="form-control" type="text" name="" id="delete-nombreEstadoUsuario">
     ...
     <script src="../src/js/crud_estadousuario.js" ></script>
