...
<div class="contenedor active" id="contenedor">
        ...
        <main class="main">
            ...
            <div class="wrap-table100" id="wrap-table">
                <div class="card">
                <input class="input-search" type="text" name="" placeholder="Buscar Rol" id="searchRegister">

                    <div class="card-header">
                      
                      <h3 class="table-h3">Tabla de Roles</h3>
                      ...
                      <table class="table table-striped table-hover">
                        <thead>
                          <tr>
                            ...
                            <tbody>
                               <tr  v-for="(Rol, index) in roles" v-show="index >=  anterior && index < siguiente">
                                  <td>{{Rol.id}}</td>
                                  <td>{{Rol.nombreRol}}</td>
                                  <td>
                                    <button  type="button"  class="btn btn-success "  data-toggle="modal" data-target="#updateModal" @click= "setDatos(Rol)" ><i class="far fa-edit"></i></button>
                                    <button type="button"  class="btn btn-delete " data-toggle="modal" data-target="#deleteModal" @click= "setDatosDelete(Rol)"><i class="fas fa-trash-alt"></i></button>
                                  </td>
                            </tr>
        ...
        <!-- Modal insertrar -->
            ...
            <div class="modal-dialog ">
              <div class="modal-content">
                   ...
                   <form action="" class="">
                    <div class="row">
                      <div class="form-group col">
                          ...
                          <input class="form-control" type="text" name="" id="insert-nombreRol">
                      </div>
                    </div>
                  </form>
                </div>
                ...
                <button type="button" class="btn btn_cancel" data-dismiss="modal">Close</button>
                  <button type="button" class="btn btn_confirm" data-dismiss="modal"  data-dismiss="modal" @click="insertar()">Guardar</button>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="modal-dialog ">
              <div class="modal-content">
                  ...
                  <form action="" class="">
                    <div class="row">
                      <div class="form-group col">
                          ...
                          <input class="form-control" type="text" name="" id="update-nombreRol">
                      </div>
                    </div>
                ...
                <div class="modal-footer">
                  ...
                  <button type="button" class="btn btn_confirm" data-dismiss="modal" data-dismiss="modal" @click="update()">Guardar</button>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog ">
              <div class="modal-content">
                <div class="modal-header">
                  <h3 class="modal-title" id="exampleModalLabel"> Eliminar Rol</h3>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                  ...
                  <form action="" class="">
                    ...
                    <div class="container-alert mt-0">
                      ...
                      <div class="form-group col">
                          ...
                          <input class="form-control" type="text" name="" id="delete-nombreRol" disabled>
                ...
                <div class="modal-footer">
                  <button type="button" class="btn btn_cancel" data-dismiss="modal">Cancelar</button>
                  <button type="button" class="btn btn_confirm" data-dismiss="modal" data-dismiss="modal" @click="eliminar()">Eliminar</button>
                </div>
              </div>
            </div>
          </div>
     ...
     <script src="../src/js/crud_Roles.js"></script>
